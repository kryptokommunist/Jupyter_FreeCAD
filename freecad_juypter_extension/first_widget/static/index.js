define(["jupyter-threejs","@jupyter-widgets/base","three"], function(__WEBPACK_EXTERNAL_MODULE_2__, __WEBPACK_EXTERNAL_MODULE_3__, __WEBPACK_EXTERNAL_MODULE_7__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
// dynamically.
__webpack_require__.p = document.querySelector('body').getAttribute('data-base-url') + 'nbextensions/first-widget/';
...
var _jupyterThreejs = __webpack_require__(2);
...
var _ = __webpack_require__(4); // Custom Model. Custom widgets models must at least provide default values
...
module.exports = {"name":"first-widget","version":"0.1.0","description":"A Hello World Jupyter widget inspired by the Jupyter doc","author":"Olivier Coudray","main":"lib/index.js","repository":{"type":"git","url":"https://github.com/ocoudray/first-widget"},"keywords":["jupyter","widgets","ipython","ipywidgets"],"files":["lib/**/*.js","dist/*.js"],"scripts":{"clean":"rimraf dist/","prepare":"webpack","watch":"watch 'npm run prepare' lib/","test":"echo \"Error: no test specified toto\""},"devDependencies":{"@babel/cli":"^7.10.4","@babel/core":"^7.10.4","@babel/plugin-proposal-object-rest-spread":"^7.10.4","@babel/preset-env":"^7.10.4","@babel/preset-react":"^7.10.4","babel-plugin-transform-es2015-destructuring":"^6.23.0","css-loader":"^0.28.7","extract-text-webpack-plugin":"^3.0.1","rimraf":"^2.6.1","style-loader":"^0.18.2","watch":"^1.0.2","webpack":"^3.5.5"},"dependencies":{"@jupyter-widgets/base":"^1.0.0","d3":"^4.10.2","jupyter-threejs":"^2.2.0","lodash":"^4.17.4"}}
